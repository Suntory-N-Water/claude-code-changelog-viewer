...
[Web search](/docs/en/tools-reference#websearch-tool-behavior)
✓
✓
✗
✓
...
✓ ([Owner-enabled](/docs/en/fast-mode#enable-fast-mode-for-your-organization) on Team and Enterprise)
...
[Cross-session messaging](/docs/en/cross-session-messaging)
✓ (macOS and Linux) 6
✓ (macOS and Linux) 6
✗
✗
...
[`/loop` scheduled tasks](/docs/en/scheduled-tasks)
✓
✓
See note 3
See note 3
...
[Analytics dashboard and API](/docs/en/analytics)
...
8 Not included in the standard Enterprise plan. Requires separate enablement by Anthropic for qualified accounts. See [Zero Data Retention](/docs/en/zero-data-retention).
