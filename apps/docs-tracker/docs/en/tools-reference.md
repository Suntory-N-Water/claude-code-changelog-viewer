...
| `TaskStop` | Stops a running background task by ID. As of v2.1.198, also accepts an [agent-team teammate](/en/agent-teams) or a named background agent by agent ID or name | No |
