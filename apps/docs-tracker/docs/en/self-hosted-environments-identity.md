---
title: self-hosted-environments-identity
...
> Verify the CLAUDE\_CODE\_SESSION\_ACCESS\_TOKEN JWT so services on your network can trust requests from sessions in your self-hosted environment.
