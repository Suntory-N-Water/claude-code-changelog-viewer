...
source: https://code.claude.com/docs/ja/discover-plugins.md
---
...
プラグインを選択してその詳細を表示します。Claude Code v2.1.143 以降では、詳細ペインに **Context cost** の推定値が含まれており、インストール前に、プラグインが毎ターン [コンテキストウィンドウ](/ja/features-overview#understand-context-costs) に追加するトークン数を確認できます。v2.1.144 以降では、ペインにプラグインの **Last updated** 日付も表示されます。
