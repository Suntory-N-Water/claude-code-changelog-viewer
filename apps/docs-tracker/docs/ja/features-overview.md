...
source: https://code.claude.com/docs/ja/features-overview.md
---
...
LSP ツールは、言語の[コード intelligence プラグイン](/docs/ja/discover-plugins#code-intelligence) をインストールするまで非アクティブです。
