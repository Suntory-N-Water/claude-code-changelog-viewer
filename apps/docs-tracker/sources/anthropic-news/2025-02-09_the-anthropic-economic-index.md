...
published_at: "2025-02-09T15:00:00.000Z"
content_hash: 25df82f26df91c86aa5ba0e48cccd26a21df8958e10b28c5e38dfe52fa101e9f
lang: en
---
...
The Index’s [initial report](http://arxiv.org/abs/2503.04761) provides first-of-its-kind data and analysis based on millions of anonymized conversations on [Claude.ai](http://claude.ai/redirect/website.v1.d51427cf-a669-4a6c-abc9-3e05a0c2d29e), revealing the clearest picture yet of how AI is being incorporated into real-world tasks across the modern economy.
...
*   We also only analyze data from [Claude.ai](http://claude.ai/redirect/website.v1.d51427cf-a669-4a6c-abc9-3e05a0c2d29e) Free and Pro plans, rather than API, Team, or Enterprise users. While Claude.ai data contains some non-work conversations, we used a language model to filter this data to only contain conversations relevant to an occupational task, which helps to mitigate this concern.
