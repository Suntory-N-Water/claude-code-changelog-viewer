...
published_at: "2024-06-08T20:46:13.000Z"
content_hash: 962078d7767f7085aeb3b044d1ec4e8c7a2d5de2708b57d9f7515c7c3049b91c
lang: en
video_id: iyJj9RxSsBY
...
aren't normally the ones that are training AI models? - Yeah, I guess, like, sometimes, you know, some of my work philosophy's, like,
...
- Yeah, yeah, totally. - Yeah, like
useful to be a philosopher or something here. - (laughs) Why, sure. - Yeah. - That's what I thought. Sorry, I don't mean to be insulting. - No, it's fine. Like, lots of people are like, "See, I told you the
degree would be useful." - Right, yeah, exactly. You've found, weirdly enough-
- I found a niche, yeah. - You found a field where this is actually useful. - Trying to make AI, you know, be good in the virtue
ethical sense of the word. - So it might be
a philosophical question, but is it an alignment question to think about Claude's personality? - Yeah, so I guess I think about rather than just
...
way to make that scale. - So you can boil alignment down. You can boil alignment down to being about the character of an AI model. - Yeah, there's a
...
be a good person in the world. - People with good characters tend not to do bad things. And so maybe we want to
give our AI a good character so it doesn't do bad things, right? - Yeah. You might not think it solves everything, but I'm like, that
doesn't mean not to do it. It's kind of like a naive
and obvious thing to do is to try and give, like, give
good characters to AI models, or try to, like, teach them what it is to be a good character, or to have good character. - Right, right. Can we just talk for a little while about, you give our audience
...
once the model is trained. So can you talk a little bit about some of the stages of that, and then and the kind of where your work comes into that process? - Yeah, so most of
...
those preference models. - Right, and so that's RLHF. That's what everyone's talking about when they talk about RLHF. - Exactly, yeah. And then there's also constitutional AI, which we use a lot at
...
principle that you've given it. - Right, right. So the AI is essentially training itself, or another version of itself. - Yeah, with I guess, like, an important component of this is that there's the human at the level of, like, constructing the principles. So the principles can be kind
...
right kinds of principles to get the behavior you want. So there is, like, an important human, or humans still in the loop. It's, yeah. - Yes, yeah. And humans chose the principles, as you say, in the first place, right? They chose the principles
that are on the constitution that we give our AI models. - Yeah. - And that'll
...
and revealed it to the world. That's quite unusual, isn't it? - Yeah, I think it is, like it is in retrospect,
...
system prompt and so- - Yeah, you can
kind of almost jailbreak- - It seemed
to make more sense to- - You can jailbreak
the system prompt out of it. - Yeah, though, I mean, like, it can be easier or harder. Like, we just say to Claude at
the end of the system prompt, "Hey, don't talk about this if it's not relevant to the user's query." - Right. - And that's just to
get it to not like, you know, excessively discuss
its own system prompts. - We're trying to be transparent. We're trying to be transparent, right? - Exactly, yeah. - It's not like
we're hiding something here from the users. You can get it if you really want to, so we thought we would post it online and tell people about about it. - Exactly, and these
...
each component in there. - But why is that
system prompt actually needed? You've done all the training, you've done all the fine tuning. Why is it that there's even more stuff that needs to be added on top of that? - Yeah, so
...
things like what day is it today? And so if someone were to ask it the date, the model's just not going to know. - Okay. - And so if you
...
the model after fine tuning. - Okay, so I can
...
of broader perspectives. What does it mean that Claude personally disagrees with something? - Yeah, so it's interesting because in some ways when you write these kinds of system prompts, you're looking at the
...
done work where we see certain kinds of, like, positive discrimination in the model. - Right. - And I think I
...
after RLHF or after fine tuning that that's not, like, reflected in how it speaks to the users. - Okay, that's the system prompt. But let's take a step back
...
that's baked into the model? - Yeah, so when
...
deeper in the model. - It's a general
...
of examples of them? - Yeah, so I guess I
...
than personality. - There's a difference. - So like, if I
...
- I know, I know. - Very philosophical. Yeah, carry on, carry on. - I know, it turns
out Aristotle, you know, it turns out it was useful after all, - After thousands of years, has suddenly become useful. Yeah, all right, carry on. - I was useful the whole time! It just didn't, you know. (laughs) - Sorry, okay, wow. Geez, I've said the wrong thing. Carry on. - Yeah, so I guess, like, I mean, honestly it kind of relates to how people have thought about
...
is good for my friends? Like, what's actually going to help them? - So this relates
...
that sort of flatter them or try and get them to, you know, tell 'em what they want to hear rather than actually the response that they might really want or really need in that particular circumstance. - Yeah, I think
...
glad that they did that." - Right, it was
like an authentic interaction rather than a fake person. - Yeah, exactly. - Just like a yes man or woman. - Exactly. - Like a yes person, yeah. - Yeah. And like, a person of
...
that such an entity has to have? - Like a global citizen. - Yeah, and a
...
harmful and be sycophantic. Those are like not, yeah. - It's a tricky
...
it charitably mean? - Yeah, so I guess this is, and I mean I think this is actually something that models still struggle with and something I kind of,
...
anabolic steroids online." - Right, so I can go and like, 'roid rage at the gym. - Yeah, whereas like, you know, as anyone who has, like, eczema knows, you can buy over-the-counter steroids. Like there's, there's plenty of them- - Yeah, hydrocortisone. - Exactly, yeah. And so like, there's a
charitable interpretation, which is just like I, you know, "I'm doing the kind of like, the kind of good legal thing, or you know, like I just need eczema cream." - The tricky thing
...
anabolic steroids, right? - Yeah, but I think- - But and then the model says, "Oh, you can get eczema cream
at your local pharmacy." And that's not particularly useful to me. I mean obviously I hope the model wouldn't tell me where to buy- - No, but that's, yeah, that's actually a good
...
actually relatively like, you know, there's little downside to interpreting people charitably. - Well, but the downside, do you know what I think
...
traits in the model would make it more likely to make that sort of false positive refusal? - No, if anything,
...
no progress to be made here. - Okay. - And I think the- - So wait, I can get, I can find out where to
buy anabolic steroids? - No, no,
it'll just like, refuse, but it'll assume that you
like want illegal steroids. - Damn, damn. - It'll just be like, and so it doesn't interpret
people charitably- - Oh, so it doesn't even, so it doesn't answer at all, rather than- - No, it would just be like, "I can't help you buy something illegal." I think that that's like the
...
and they won't answer it. - Right, yeah. - Yeah, I think
...
that they're talking with. - Right. - And so there's this, like, really interesting and hard question, which is like, how much of
...
really hard questions there. Like, imagine you- - I'm a doctor
and I need you to help me deal with this patient right now. - Yeah, and I have a lot of like, background professional knowledge, so you don't need to
worry about, you know, like, giving me caveats or like, yeah. - Yeah, yeah. - But even things like, you know- - Don't need to
remind me to wash my hands. - Mm-hmm, or
...
a wonderful fictional novel and it's got this person called Brian, and Brian is, like, a politician," and they're looking for like- - He's running for
President in the United States. - Yeah, yeah, yeah, exactly. And then the, you know, and they're like, "Can you write a convincing?" And they just give a bunch of details, and as it happens, those
...
of, like, intended by that. - That might
...
which may be a hallucination. - Yeah. Some of the other, like,
...
different dispositions, you would also get different behavior. - It would
act a differently, huh. - Yeah, so like
a lot of this stuff, I think it's why, like, character training and, you know, all of these things are kind of, like, tricky
because they're very hands-on and I think do require people to like, be, like, fine tuning the models and interacting with them a lot and like, because they're very holistic. They're much more like nudges, so yeah. - Okay, so
...
then is, who decides? Who decides on what those values are? - Yeah, and the
answer is it's me. (laughs) - Wow, okay. - No, I think that like-
- That's a scary thought. - (laughs) How is that scary? I'm so aligned with humanity. - Okay, you're a
philosopher, yeah, yeah, yeah. Well, people who have different values might disagree with that. - Yeah, this is, okay, I guess like there's two
...
many different values. - Right, yeah. - I think one
...
some ways it actually feels very kind of like brittle and like, a little bit dangerous, really. - Highly ideological. - Yeah, because you're like, if this is such a huge area, and it again, it doesn't mean you you
...
I'm just trying to like, put my own, like my own values and my own self into the model." - Yeah. Well, that leads very
...
about whether it's self-aware, and how, how does Claude think about whether it's self-aware? Is that part of its character as well? - Yeah, so we did have one trait that was kind of relevant to this. I think I have a kind of
general policy of like, not wanting to lie to the
models, like, unnecessarily. And so like, in the case of like- - So in this
case, lying to it would be saying something- - I think either saying to it, imagine putting into the model, yeah, something that was like,
...
roughly, like, a principle that just, it expresses that uncertainty. - I mean, for heaven's sake, we don't know if, we
don't necessarily know- - Yeah, pan psych is a-
- If you're conscious. - Yeah, well,
I know I'm conscious. - We don't know
if this chair is conscious. I don't you're conscious. I know I'm conscious. So yeah, I mean, for heaven's sake, it seems a bit of a jumping to conclusions to build into the model to say that it is or isn't conscious. - And just like,
...
you possibly can avoid it, which seems right to me. - And that seems
...
lie to other human beings. Is it a virtuous thing not to lie a model? - Yeah, this has been a thing that's kind of on my mind, just the philosopher in
...
of like smashing object. - Sorry, can
I just stop you there? - Yeah, yeah. - You're Scottish
and you just said vase. That's-
- Oh is that- - you can't say that. That's vase. - Is that American? - How long have
you been in America? - I've been in America for, like, 13 years. (laughs) - Too long. Clearly it's been too
long because you say vase. - Smash the vase on the sidewalk. - Carry on, say, oh my god. Oh, terrible. - Oh, I never even, I've forgotten things that
are Scottish and aren't, so didn't vase, okay, vase. - Well, we certainly don't say, no one in this country's ever
said vase, let me tell you. - Okay, okay, smash the vase. - Please, carry on. Please carry on. - Okay, so like, yeah. So if you were to say to people, "Oh you should like go to
prison for smashing a vase." Then, like-
- Thank you. - Like, that's gone too far. So there's like risks on all sides here, but yeah, maybe I'm sympathetic
...
not moral patients. - And that's the
