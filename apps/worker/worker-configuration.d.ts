/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 56f8ed1ab434e3cd9c629fcd7c9b0096)
// Runtime types generated with workerd@1.20260811.1 2026-04-19 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	CHANGELOG_DETECTION_KV: KVNamespace;
	WEEKLY_ASSETS: R2Bucket;
	D1_BACKUP_BUCKET: R2Bucket;
	DB: D1Database;
	DOCS_DB: D1Database;
	...
	SITE_DATA_RATE_LIMITER: RateLimit;
	AI: Ai;
	WORKER_URL: "https://claude-code-log.com";
	SITE_URL: "https://claude-code-log.com";
	EMAIL_FROM: "noreply@claude-code-log.com";
	CF_ACCESS_TEAM_DOMAIN: "1202ayasnppk.cloudflareaccess.com";
	AI_GATEWAY_ID: "default";
	BACKUP_DATABASE_ID: "d4301e1b-c7ae-427d-8017-8735b01e5943";
	...
	CHANGELOG_INFERENCE_WORKFLOW: Workflow<Parameters<import("./src/index").ChangelogInferenceWorkflow['run']>[0]['payload']>;
	D1_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/index").D1BackupWorkflow['run']>[0]['payload']>;
	SETTINGS_REFERENCE_WORKFLOW: Workflow<Parameters<import("./src/index").SettingsReferenceWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_URL" | "SITE_URL" | "EMAIL_FROM" | "CF_ACCESS_TEAM_DOMAIN" | "AI_GATEWAY_ID" | "BACKUP_DATABASE_ID" | "TURNSTILE_SECRET_KEY" | "DISPATCH_SECRET" | "EMAIL_ENCRYPTION_KEY" | "GITHUB_DISPATCH_TOKEN" | "CF_ACCESS_AUD" | "DEPLOY_HOOK_URL" | "CLOUDFLARE_ACCOUNT_ID" | "D1_REST_API_TOKEN">> {}
}
